            ...
            <table className="w-full">
              <thead className="sticky top-0 z-20 bg-white">
                <tr>
                  ...
                  <th className="py-3 px-4 bg-gray-50 border-b border-gray-200 w-[290px]"></th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {orderItems.map((order, orderIndex) => (
                  <tr key={`${order.orderTime}-${order.table}-${orderIndex}`}>
                    <td className="pt-2 pb-0 px-2 align-top w-[150px]">
                      {order.orderTime}
                    </td>
                    <td
                      className={`pt-2 pb-0 px-2 align-top font-medium w-[150px] ${
                        getMinutes(order.elapsedTime) > 15
                          ? "text-red-500"
                          : "text-gray-900"
                      }`}
                    >
                    ...
                    <td className="pt-2 pb-0 px-2 align-top w-[100px]">
                      {order.table}
                    </td>
